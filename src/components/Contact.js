...
const Contact = () => {
    return (
        <div name='contact' className=' bg-[#0a192f]'>
            <div className='w-full min-h-screen bg-[#0a192f] flex justify-center items-center p-4'>
                <form data-aos="zoom-in-up" data-duration="2000" method='POST' action="https://getform.io/f/46c1fe50-e136-439b-bf69-bf03332ef43c" className='flex flex-col max-w-[600px] w-full'>
                    <div className='pb-8'>
